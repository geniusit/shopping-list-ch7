<template>
  <span>
    ...
    <i class='toggle-volume glyphicon' v-show="isStarted && !isPaused && isWorking" 
      :class="{ 'glyphicon-volume-off': isSoundEnabled, 'glyphicon-volume-up': !isSoundEnabled }" @click="toggleSound"></i>
  </span>
</template>
